...
from pydantic import Field, model_serializer, model_validator, BaseModel, computed_field, field_validator
...
class SchemaRecord(BaseSchema):
    ...
    vendor_id: Optional[str] = Field(
        default=None, 
        description="The internal vendor ID assigned by the Sub-contractors Registry."
    )
    company_name: str = Field(
        description="The best-available resolved name for the business after survivorship logic."
    )
    address_1: Optional[str] = Field(
        default=None, 
        description="Primary street address of the business headquarters."
    )
    postal_code: Optional[str] = Field(
        default=None, 
        description="The 5-digit ZIP or postal code."
    )
    city: Optional[str] = Field(
        default=None, 
        description="The city where the business is registered or primarily operates."
    )
    is_active: Optional[bool] = Field(
        default=None, 
        description="Indicates if the business is currently marked as active in the source registries."
    )
    naics_code: Optional[str] = Field(
        default=None, 
        description="North American Industry Classification System code."
    )
    naics_code_label: Optional[str] = Field(
        default=None, 
        description="The human-readable description of the NAICS industry code."
    )
    certification_type: Optional[str] = Field(
        default=None, 
        description="Diversity or status certification (e.g., MBE, WBE, DBE, VOSB)."
    )
    trade_specialty: Optional[str] = Field(
        default=None, 
        description="The primary trade or area of expertise (e.g., Masonry, HVAC, Security)."
    )
    licenses: Optional[list[ModelLicense]] = Field(
        default=None,
        description="A collection of all associated licenses found across all source records in this cluster."
    )
...
class Record(BaseRecord):
    ...
    anchor_entity_id: str = Field(description="The primary Unique Entity ID (UEI). Acts as the global anchor for the record.", alias='anchor_entity_id')
    ...
    source_data_source: Optional[str] = Field(default=None,description="The source of the ID as it exists in the original registry", alias='alt_data_source')
    vendor_id: Optional[str] = Field(
        default=None, 
        description="The internal vendor ID assigned by the Sub-contractors Registry."
    )
